cells: cells.o maths.o libisentlib.a
	gcc -Wall cells.o maths.o -o cells libisentlib.a -lm -lglut -lGL -lX11
...
cells.o: cells.c GfxLib.h BmpLib.h ESLib.h maths.h
	gcc -Wall -c cells.c

maths.o: maths.c GfxLib.h maths.h
	gcc -Wall -c maths.c
